...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
        <p><strong>Don't worry this is Laravel limitation.Laravel 8 session disappearing after redirection </strong></p>
...
{{--        </span>--}}
        <br>
        <a class="text-green-600" href="{{route('product_list')}}" style="font-size: 26px">Go to Home</a>
        <p style="font-size: 10px">When you use sessions, a SESSION_ID (or similar) cookie is sent to the browser to know what session is associated with each request.
